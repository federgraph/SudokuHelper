...
{$SCOPEDENUMS ON}
  ...
  ['{297A2DBD-BD80-4FEE-9C8B-DB7E3CBB9BA2}']
    ...
    {! Toggle the EvenOnly property, use only for Sudoku Gosu!
     Also updates the Valid state id the cell is not empty.
     This action can be undone. }
  ...
  ['{360B7556-CD9B-48B6-B400-858573CBD854}']
    ...
    property OnRedrawCell: TRedrawCellEvent read GetOnRedrawCell write SetOnRedrawCell;
  end;
  ...
  ['{DB616905-F1C2-47FF-A137-B84DA9A416C6}']
    ...
    {!
    <value>
     String describing the Sudoku type the helper supports,
  ...
  {! Exception raised if validation of a cell's column or row index fails. }

...
function InterlockedExchangeObject(var Target; Value: TObject): TObject; stdcall;
...
function InterlockedExchangeHandle(var Target; Value: THandle): THandle; stdcall;
...
be nil!</remarks> }
function InterlockedCompareExchangeObject(var Target; Exchange, Comparand: TObject): TObject; stdcall;
...
function InterlockedCompareExchangeHandle(var Target; Exchange, Comparand: THandle): THandle; stdcall;
